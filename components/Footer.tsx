        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 justify-between pb-10 xl:pb-15">
          <div className="max-w-[330px] w-full">
            ...
            <ul className="flex flex-col gap-3">
              <li className="flex gap-4.5">
                ...
                2023 Brumbaugh Cemetery Road, Saxton, PA 16678, United States.
              </li>
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="flex flex-col gap-3.5">
              <li>
                <Link className="ease-out duration-200 hover:text-blue" href="/myAccount">
                  My Account
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link className="ease-out duration-200 hover:text-blue" href="/all">
                  Shop
                </Link>
              </li>
            </ul>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-between">
            <p className="text-dark font-medium">
              &copy; {year}. All rights reserved by Carol's Closet.
            </p>
